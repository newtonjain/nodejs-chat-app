...
var ExpressProxyMiddleware = (function () {
    ...
    ExpressProxyMiddleware.setupRouteMethod = function (express, method) {
        ...
        if (oldMethod) {
            express.Route.prototype[method] = function newMethod() {
                if (Tracing_1.default.isEventEnabled(ExpressProxy_1.ExpressProxy.EVENT_INVOKE_PRE_EXPRESS_ROUTE_METHOD)) {
                    var data = {
                        originalThis: this,
                        originalArgs: arguments,
                        methodName: method
                    };
                    Tracing_1.default.publish(ExpressProxy_1.ExpressProxy.EVENT_INVOKE_PRE_EXPRESS_ROUTE_METHOD, data);
                }
    ...
    ExpressProxyMiddleware.setupRouterNaming = function (express) {
        ...
        var newRouter = function newRouter() {
            ...
            if (Tracing_1.default.isEventEnabled(ExpressProxy_1.ExpressProxy.EVENT_INVOKE_PRE_EXPRESS_ROUTER)) {
                var data = {
                    originalThis: this,
                    originalArgs: arguments,
                    router: router
                };
                Tracing_1.default.publish(ExpressProxy_1.ExpressProxy.EVENT_INVOKE_PRE_EXPRESS_ROUTER, data);
                router = data.router;
            }
            return router;
        };
    ...
    ExpressProxyMiddleware.setupRouterMiddleware = function (express) {
        ...
        express.Router.use = function newUse() {
            if (Tracing_1.default.isEventEnabled(ExpressProxy_1.ExpressProxy.EVENT_INVOKE_PRE_EXPRESS_ROUTER_USE)) {
                var data = {
                    originalThis: this,
                    originalArgs: arguments
                };
                Tracing_1.default.publish(ExpressProxy_1.ExpressProxy.EVENT_INVOKE_PRE_EXPRESS_ROUTER_USE, data);
            }
    ...
    ExpressProxyMiddleware.setupStaticMiddleware = function (express) {
        ...
        express.static = function newQuery() {
            ...
            if (Tracing_1.default.isEventEnabled(ExpressProxy_1.ExpressProxy.EVENT_INVOKE_PRE_EXPRESS_STATIC)) {
                var data = {
                    originalThis: this,
                    originalArgs: arguments,
                    middleware: middleware
                };
                Tracing_1.default.publish(ExpressProxy_1.ExpressProxy.EVENT_INVOKE_PRE_EXPRESS_STATIC, data);
            }
            return middleware;
        };
    };
...
//# sourceMappingURL=../../../maps/tracing/proxies/ExpressProxyMiddleware.js.map
