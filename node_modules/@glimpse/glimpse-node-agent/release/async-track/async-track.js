...
var AsyncTrack = (function () {
    ...
    AsyncTrack.prototype.instrumentCommon = function () {
        ...
        //
        // TODO:  https://github.com/Glimpse/Glimpse.Node.Prototype/issues/437
        // 
     ...
     */
    AsyncTrack.prototype.instrumentPromise = function () {
        var promiseThen = Promise.prototype.then;
        var promiseCatch = Promise.prototype.catch;
        ...
        function wrapOnFullfilled(onFulfilled, onRejected) {
            ...
            var ret = promiseThen.apply(this, arguments);
            return ret;
        }
        function wrapOnRejected(onRejected) {
            ...
            var ret = promiseCatch.apply(this, arguments);
            return ret;
        }
        self.stamp(promiseThen, wrapOnFullfilled, thenNamePath);
        self.stamp(promiseCatch, wrapOnRejected, catchNamePath);
        Promise.prototype.then = wrapOnFullfilled;
        Promise.prototype.catch = wrapOnRejected;
    };
    return AsyncTrack;
}());
