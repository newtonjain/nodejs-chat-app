...
export class ExpressProxyMiddleware {
    ...
    private static setupRouteMethod(express, method: string) {
        ...
        if (oldMethod) {
            express.Route.prototype[method] = function newMethod() {
                ...
                if (Tracing.isEventEnabled(ExpressProxy.EVENT_INVOKE_PRE_EXPRESS_ROUTE_METHOD)) {
                    const data = {
                        originalThis: this,
                    ...
                    Tracing.publish(ExpressProxy.EVENT_INVOKE_PRE_EXPRESS_ROUTE_METHOD, data);
                }
    ...
    private static setupRouterNaming(express) {
        ...
        const newRouter = function newRouter() {
            ...
            if (Tracing.isEventEnabled(ExpressProxy.EVENT_INVOKE_PRE_EXPRESS_ROUTER)) {
                const data = {
                    originalThis: this,
                    originalArgs: arguments,
                    router: router
                ...
                Tracing.publish(ExpressProxy.EVENT_INVOKE_PRE_EXPRESS_ROUTER, data);
                router = data.router;
    ...
    private static setupRouterMiddleware(express) {
        ...
        express.Router.use = function newUse() {
            ...
            if (Tracing.isEventEnabled(ExpressProxy.EVENT_INVOKE_PRE_EXPRESS_ROUTER_USE)) {
                const data = {
                    originalThis: this,
                    originalArgs: arguments
                };

                Tracing.publish(ExpressProxy.EVENT_INVOKE_PRE_EXPRESS_ROUTER_USE, data);
            }
    ...
    private static setupStaticMiddleware(express) {
        ...
        express.static = function newQuery() {
            ...
            if (Tracing.isEventEnabled(ExpressProxy.EVENT_INVOKE_PRE_EXPRESS_STATIC)) {
                const data = {
                    originalThis: this,
                    originalArgs: arguments,
                ...
                Tracing.publish(ExpressProxy.EVENT_INVOKE_PRE_EXPRESS_STATIC, data);
            }
